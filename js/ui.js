...
function getLinkedInRedirectErrorMessage(reason) {
    const messages = {
        ...
        linkedin_redirect_uri_mismatch: 'عنوان الرجوع في LinkedIn لا يطابق إعدادات التطبيق.',
        linkedin_client_credentials_invalid: 'Client ID أو Client Secret غير صحيح.',
        linkedin_code_expired: 'انتهت صلاحية رمز LinkedIn؛ أعد محاولة الربط من جديد.',
